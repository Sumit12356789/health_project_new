...
const GetCourse=async()=>{
  ...
  return ( 
    <div className='px-10 md:px-20 lg:px-44 my-7'>
      <h2 className='text-center font-extrabold text-2xl my-3 text-primary'> Congrats! Your course is Ready</h2>
      <h2 className='text-center text-gray-400 border p-2 rounded-md'>{process.env.NEXT_PUBLIC_HOST_NAME}/course/view/{course?.courseId}</h2>
